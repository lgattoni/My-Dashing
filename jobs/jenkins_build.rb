...
JENKINS_URI = URI.parse("http://jenkins.etai.fr:80")
...
# the key of this mapping must be a unique identifier for your job, the according value must be the name that is specified in jenkins
 job_mapping = {
   'job1' => { :job => 'ARIANE_BUILD_TRUNK'},
   'job2' => { :job => '09_CREATE_TAG_FOR_MODULES'},
   'job3' => { :job => 'RELEASE_FROM_BRANCH'},
   'job4' => { :job => 'eCar_TestFn_DAO'},
   }
